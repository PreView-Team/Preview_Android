...
fun createMentorList(): List<Mentor> {
    ...
    list.add(Mentor(nickname = "프리뷰1" , tag = "#대기업", title = "first",content = "content1\ncontent1" ,comments = 20, likes = 20))
    list.add(Mentor(nickname = "프리뷰2" , tag = "#대기업", title = "second",content = "content2\ncontent2" ,comments = 20, likes = 20))
    list.add(Mentor(nickname = "프리뷰3" , tag = "#대기업", title = "third",content = "content3\ncontent2" ,comments = 20, likes = 20))
    list.add(Mentor(nickname = "프리뷰4" , tag = "#대기업", title = "fourth",content = "content4\ncontent2" ,comments = 20, likes = 20))
